...
Multiple Feature Edition Of Attributes Within The Same Feature Type
    ...
    #Select Checkbox                             css:#select > .checkbox > input
    ...
    Wait Until Page Does Not Contain            Récupération des signalements en cours...
    #${otherCheckbox}        Get WebElement      
    ${checkboxClass}        Get Element Attribute       css:#table-features > tbody > tr > td > .checkbox       class
    Should Contain          ${checkboxClass}    disabled
    # Select all features of all feature types
    #${tableFeatures}                            Get WebElements             css:#table-features > tbody > tr > td > .checkbox > input
    #FOR    ${featureRow}    IN    @{tableFeatures}
    #    Log    ${featureRow}
        #${checkbox}    Call Method    ${featureRow}    find_element_by_class_name       checkbox
        #${checkboxClass}        Get Element Attribute       ${featureRow}
        #Select Checkbox                         ${featureRow}
    #END
