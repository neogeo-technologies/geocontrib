...
def export_data(request):
    ...
    if request.GET.get('project_slug', ''):
        ...
        features_type = project_features_types(APP_NAME, project_slug)
        for feature_type_slug in features_type:
            features = get_project_features(APP_NAME, project_slug, feature_type_slug)
            res_feature = []
            ...
            res[feature_type_slug] = res_feature
