# Generated by Django 2.2 on 2019-07-05 12:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(upload_to=collab.models.Project.thumbnail_dir, verbose_name='Illustration')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, max_length=256, null=True, verbose_name='Slug')),
                ('geom_type', models.CharField(blank=True, choices=[('linestring', 'Ligne brisée'), ('point', 'Point'), ('polygon', 'Polygone')], default='boolean', max_length=50, null=True, verbose_name='Type de champs géometrique')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_field', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='collab.CustomField')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='feature_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='collab.FeatureType'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
