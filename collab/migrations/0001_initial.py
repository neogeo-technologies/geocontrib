# Generated by Django 2.2 on 2019-08-02 15:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('create', 'Création'), ('update', 'Modification'), ('delete', 'Suppression')], max_length=100, verbose_name="Type de l'évènement")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='collab.Project')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(limit_choices_to=collab.models.Project.limit_arch, on_delete=django.db.models.deletion.PROTECT, related_name='access_archived', to='collab.UserLevelPermission', verbose_name='Visibilité des signalements archivés'),
        ),
        migrations.AddField(
            model_name='project',
            name='access_level_pub_feature',
            field=models.ForeignKey(limit_choices_to=collab.models.Project.limit_pub, on_delete=django.db.models.deletion.PROTECT, related_name='access_published', to='collab.UserLevelPermission', verbose_name='Visibilité des signalements publiés'),
        ),
        migrations.AddField(
            model_name='project',
            name='creator',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_type', models.CharField(choices=[('boolean', 'Booléen'), ('char', 'Chaîne de caractères'), ('date', 'Date'), ('integer', 'Entier'), ('decimal', 'Décimale'), ('text', 'Champ texte')], default='boolean', max_length=50, verbose_name='Type de champs')),
                ('feature_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='collab.FeatureType')),
            ],
            options={
